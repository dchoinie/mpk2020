    ...
    return (
      <Layout>
        ...
        <address>
          ...
          <br />
          220 Saulteax Crescent Winnipeg <br />
          R3J 3W3 - Manitoba , Canada
          <br />
          2048895430{" "}
        </address>
        <p>
          It is K-Tel International, Ltd's policy to respect your privacy
          regarding any information we may collect while operating our website.
          This Privacy Policy applies to{" "}
          <a href="https://www.minipopkids.com">https://www.minipopkids.com</a>{" "}
          (hereinafter, "us", "we", or "https://www.minipopkids.com"). We
        ...
        <p>
          Like most website operators, K-Tel International, Ltd collects
          non-personally-identifying information of the sort that web browsers
          and servers typically make available, such as the browser type,
          language preference, referring site, and the date and time of each
          visitor request. K-Tel International, Ltd's purpose in collecting
          non-personally identifying information is to better understand how
          K-Tel International, Ltd's visitors use its website. From time to
          time, K-Tel International, Ltd may release non-personally-identifying
          information in the aggregate, e.g., by publishing a report on trends
          in the usage of its website.
        </p>
        <p>
          K-Tel International, Ltd also collects potentially
          ...
          https://www.minipopkids.com blog posts. K-Tel International, Ltd only
        ...
        <p>
          Certain visitors to K-Tel International, Ltd's websites choose to
          interact with K-Tel International, Ltd in ways that require K-Tel
          International, Ltd to gather personally-identifying information. The
          amount and type of information that K-Tel International, Ltd gathers
          depends on the nature of the interaction. For example, we ask visitors
          who sign up for a blog at https://www.minipopkids.com to provide a
        ...
        <p>
          ...
          K-Tel International, Ltd and does not cover the use of cookies by any
          advertisers.
        </p>
        ...
        <p>
          K-Tel International, Ltd may collect statistics about the behavior of
          visitors to its website. K-Tel International, Ltd may display this
          information publicly or provide it to others. However, K-Tel
          International, Ltd does not disclose your personally-identifying
          information.
        </p>
        <h2>Cookies</h2>
        <p>
          To enrich and perfect your online experience, K-Tel International, Ltd
        ...
        <p>
          ...
          website each time the visitor returns. K-Tel International, Ltd uses
          cookies to help K-Tel International, Ltd identify and track visitors,
          their usage of https://www.minipopkids.com, and their website access
          preferences. K-Tel International, Ltd visitors who do not wish to have
          cookies placed on their computers should set their browsers to refuse
          cookies before using K-Tel International, Ltd's websites, with the
          drawback that certain features of K-Tel International, Ltd's websites
          may not function properly without the aid of cookies.
        </p>
        <p>
          By continuing to navigate our website without changing your cookie
          settings, you hereby acknowledge and agree to K-Tel International,
          Ltd's use of cookies.
        </p>
        <h2>E-commerce</h2>
        <p>
          Those who engage in transactions with K-Tel International, Ltd – by
          purchasing K-Tel International, Ltd's services or products, are asked
          ...
          each case, K-Tel International, Ltd collects such information only
          insofar as is necessary or appropriate to fulfill the purpose of the
          visitor's interaction with K-Tel International, Ltd. K-Tel
          International, Ltd does not disclose personally-identifying
        ...
        <p>
          Although most changes are likely to be minor, K-Tel International, Ltd
          may change its Privacy Policy from time to time, and in K-Tel
          International, Ltd's sole discretion. K-Tel International, Ltd
        ...
        <p>
          ...
          via <a href="mailto:info@minipopkids.com">email</a> or{" "}
          <a href="tel:2048895430">phone</a>.
        </p>
      </Layout>
    )
  }
