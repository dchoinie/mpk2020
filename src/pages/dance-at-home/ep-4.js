    ...
    <Layout>
      <div>
        ...
        <div className="flex flex-col items-center my-6">
          <h2 className="text-5xl lg:text-6xl">Episode #4</h2>
          <div className="flex">
        ...
        <div className="flex flex-col">
          <div className="flex flex-col lg:flex-row">
            <div className="flex flex-col items-center mb-6 w-full lg:w-1/3">
              <h3 className="text-3xl pb-2">"Old Town Road"</h3>
          ...
          <div className="flex flex-col lg:flex-row">
            <div className="w-full mb-4 lg:mb-0 lg:mr-2">
              <iframe
                width="100%"
                height="315"
                src="https://www.youtube.com/embed/iYSEIElWHoA"
                frameborder="0"
            ...
            <div className="w-full lg:ml-2">
              <iframe
                width="100%"
                height="315"
                src="https://www.youtube.com/embed/sckQCtGrAv8"
                frameborder="0"
                allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                allowfullscreen
              ></iframe>
            ...
            <div className="flex w-full lg:w-1/2 lg:mr-2 mb-2 lg:mb-0">
              <div className="flex w-full video-responsive">
                <iframe
                  width="560"
                  height="315"
                  src="https://www.youtube.com/embed/DlyiLYYg6GE"
                  frameborder="0"
                  allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                  allowfullscreen
                ></iframe>
            ...
            <div className="flex w-full lg:w-1/2 lg:ml-2">
              <div className="flex w-full video-responsive">
                <iframe
                  width="560"
                  height="315"
                  src="https://www.youtube.com/embed/caKZgy_geqE"
                  frameborder="0"
                  allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                  allowfullscreen
                ></iframe>
