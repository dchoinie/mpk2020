    ...
    return (
      <Layout>
        ...
        <p>
          ...
          use of K-Tel International, Ltd's Website.
        </p>{" "}
        <br />
        <span> K-Tel International, Ltd</span> is located at:
        <br />
        <address>
        ...
        <p>
          ...
          conditions in full. Do not continue to use K-Tel International, Ltd's
        ...
        <h2>Cookies</h2>
        <p>
          We employ the use of cookies. By using K-Tel International, Ltd's
          website you consent to the use of cookies in accordance with K-Tel
          International, Ltd's privacy policy.
        </p>
        <p>
        ...
        <h2>License</h2>
        <p>
          Unless otherwise stated, K-Tel International, Ltd and/or it's
          licensors own the intellectual property rights for all material on
          K-Tel International, Ltd. All intellectual property rights are
          reserved. You may view and/or print pages from
          https://www.minipopkids.com for your own personal use subject to
          restrictions set in these terms and conditions.
        </p>
        <p>You must not:</p>
        <ol>
          <li>Republish material from https://www.minipopkids.com</li>
          <li>
            Sell, rent or sub-license material from https://www.minipopkids.com
          </li>
          <li>
            Reproduce, duplicate or copy material from
            https://www.minipopkids.com
          </li>
        </ol>
        <p>
          Redistribute content from K-Tel International, Ltd (unless content is
        ...
        <ol>
          ...
          <li>
            ...
            ('Comments') in areas of the website. K-Tel International, Ltd does
            ...
            opinions ofK-Tel International, Ltd, its agents or affiliates.
            Comments reflect the view and opinion of the person who posts such
            view or opinion. To the extent permitted by applicable laws K-Tel
            International, Ltdshall not be responsible or liable for the
          ...
          <li>
            K-Tel International, Ltdreserves the right to monitor all Comments
          ...
          <li>
            You hereby grant to <strong>K-Tel International, Ltd</strong> a
        ...
        <p>
          ...
          outweighs the absence of K-Tel International, Ltd and (d) where the
        ...
        <p>
          ...
          e-mail to{" "}
          <a
            href="mailto:info@minipopkids.com"
            title="send an email to info@minipopkids.com"
          >
        ...
        <p>
          No use of K-Tel International, Ltd's logo or other artwork will be
