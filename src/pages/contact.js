  ...
  return (
    <Layout>
      ...
      <div>
        ...
        <p className="mb-0">Unit #160 3025 Portage Ave</p>
        <p className="mb-0">Winnipeg, MB R3K 2E2</p>
        ...
        <p>
          ...
          <a
            href="mailto:info@k-tel.com?cc=info@minipopkids.com&subject=Mini%20Pop%20Kids%20Booking%20Inquiry"
            className="pink"
          >
